...
typeset -r DAYTIME_WALLPAPER="$HOME/.dotfiles/backgrounds/.config/backgrounds/brutus.jpg"
typeset -r NIGHTTIME_WALLPAPER="$HOME/.dotfiles/backgrounds/.config/backgrounds/night.jpg"
